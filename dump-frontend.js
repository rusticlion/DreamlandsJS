...
// Output file path
const OUTPUT_FILE = 'frontend-codebase-dump.txt';

// Patterns to include in the frontend dump
...
// Main function to dump the frontend codebase
async function dumpFrontendCodebase() {
  try {
    // Get filtered files
    ...
    const now = new Date();
    writeStream.write(`# Dreamlands Frontend Codebase Dump\n`);
    ...
    console.log(`\nFrontend codebase dump complete!`);
